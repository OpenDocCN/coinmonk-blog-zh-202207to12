...
然而，空投的令牌也可以服务于许多其他功能，更重要的是，它们可以在确定如何管理协议方面发挥重要作用。各种创新的区块链和加密货币计划已经向其社区成员分发了治理令牌。
...
另一方面，一个没有经验的新人绝不会怀疑有被利用的可能。私钥盗窃、推荐风险和数据盗窃只是与空投相关的一些更普遍的欺诈行为。以下是与加密货币空投相关的危险的简明摘要。
